...
from utils.doc_process.doc_loaders.edu_ocr import get_ocr
...
if __name__ == '__main__':
    p = r'D:\workspace\pythonworkspace\chuanzhi\rag_project\datas\files\ai_data\LLM基础知识.pdf'
    #pdf_loader = OCRPDFLoader(file_path=r"D:\workspace\pythonworkspace\chuanzhi\rag_project\datas\files\ai_data\LLM基础知识.pdf")
